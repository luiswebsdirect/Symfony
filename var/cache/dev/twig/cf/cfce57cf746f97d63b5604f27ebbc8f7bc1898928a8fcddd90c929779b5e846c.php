...
class __TwigTemplate_f7488ed96e82f8c2389d91fa81982de731cc36f77f0c843e3b559551cd45953f extends Twig_Template
{
    private $source;
...
<div>
    <ul>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["noticia"]) {
            // line 15
            echo "            <li>";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["noticia"], "textoNoticia", []), "html", null, true);
            echo " Fecha: ";
...
";
    ...
    {
        return array (  126 => 17,  115 => 15,  111 => 14,  103 => 10,  94 => 9,  77 => 6,  58 => 5,  48 => 9,  44 => 7,  42 => 6,  38 => 5,  32 => 1,);
    }
...
<head>
    <meta charset=\"UTF-8\">
    <title>{% block title %}Noticias-{{ titulo }}{% endblock %}</title>
...
<div>
    <ul>
        {% for noticia in noticias%}
            <li>{{ noticia.textoNoticia}} Fecha: {{noticia.fecha}}</li>
        {% endfor %}
    </ul>
