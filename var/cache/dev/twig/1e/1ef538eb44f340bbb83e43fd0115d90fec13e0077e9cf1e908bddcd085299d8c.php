...
class __TwigTemplate_d0fd119df93c9152549e055bfc86fd65afb466090d08cdd8dfbc37b61a19f8e2 extends Twig_Template
{
    private $source;
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "-";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["noticias"] ?? null), "equipo", []), "html", null, true);
        echo "</h1>
...
";
    ...
    {
        return array (  113 => 14,  103 => 10,  94 => 9,  77 => 6,  58 => 5,  48 => 9,  44 => 7,  42 => 6,  38 => 5,  32 => 1,);
    }
...
<head>
    <meta charset=\"UTF-8\">
    <title>{% block title %}Noticias-{{ noticias.seccion }}{% endblock %}</title>
    {% block stylesheets %}{% endblock %}
</head>

{% block body %}
<h1>{{ titulo }}-{{ noticias.equipo }}</h1>
