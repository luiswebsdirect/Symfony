...
class __TwigTemplate_8f4c66ab73159be8494d4f2c92e03e06f060d1f65c838ad5aadfff9d15b5528a extends Twig_Template
{
    private $source;
...
<div class=\"metrics\">
    <div class=\"metric\">
        <span class=\"value\">";
        // line 5
        echo twig_escape_filter($this->env, ((twig_get_attribute($this->env, $this->source, ($context["request"] ?? null), "route", [])) ? (twig_get_attribute($this->env, $this->source, ($context["request"] ?? null), "route", [])) : ("(none)")), "html", null, true);
        echo "</span>
    ...
    ";
        // line 9
        if (twig_get_attribute($this->env, $this->source, ($context["request"] ?? null), "route", [])) {
            // line 10
...
";
    ...
    ";
            // line 20
            if (twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["request"] ?? null), "routeParams", []))) {
                // line 21
    ...
    ";
                ...
                // line 25
                echo "        ";
                echo twig_include($this->env, $context, "@WebProfiler/Profiler/table.html.twig", ["data" => twig_get_attribute($this->env, $this->source, ($context["request"] ?? null), "routeParams", []), "labels" => [0 => "Name", 1 => "Value"]], false);
                echo "
    ";
            }
        }
...
";
        // line 29
        if (twig_get_attribute($this->env, $this->source, ($context["router"] ?? null), "redirect", [])) {
            // line 30
    ...
    <div class=\"card break-long-words\">
        ";
            // line 34
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["router"] ?? null), "targetUrl", []), "html", null, true);
            echo "
        ";
            // line 35
            if (twig_get_attribute($this->env, $this->source, ($context["router"] ?? null), "targetRoute", [])) {
                echo "<span class=\"text-muted\">(route: \"";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["router"] ?? null), "targetRoute", []), "html", null, true);
                echo "\")</span>";
            }
            // line 36
            echo "    </div>
...
<div class=\"card\">
    <strong>Path to match:</strong> <code>";
        // line 42
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["request"] ?? null), "pathinfo", []), "html", null, true);
        echo "</code>
</div>
...
", "@WebProfiler/Router/panel.html.twig", "C:\\xampp\\htdocs\\Deportes_Symfony\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Router\\panel.html.twig");
    }
}
