...
return $this->privates['security.user.provider.concrete.in_memory'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(['carlos' => ['password' => 'pass', 'roles' => [0 => 'ROLE_USER']], 'admin' => ['password' => 'word', 'roles' => [0 => 'ROLE_ADMIN']]]);
